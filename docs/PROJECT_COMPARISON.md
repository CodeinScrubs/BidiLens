...
| canonical BidiLens checkout | 12 | 15 | 1,248 | 3 / 63 | 925 |
...
| Corpus schemas and numbered words | Implemented with JSON Schema and 925 direction-exact cases; 204 also carry exact isolation expectations, five carry security-code expectations, and numbered-order arrays are schema/permutation fixtures rather than rendered-geometry oracles |
...
| Demo presets and inspectors | Adopted and extended into a complete offline bilingual playground: policy/security and stream controls, four-way live input, AST/evidence/isolation/security, searchable 925-case asset, copy verification, semantic HTML/JSON export, hash state, theme, and an opt-in Pages workflow |
...
The general corpus row above is now 925 cases, not 722: 729 authored/generated
