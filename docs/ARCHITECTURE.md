...
tables and 925-case fixtures are generated from the same canonical inputs as
...
semantics. The crate validates the same 925 direction fixtures and all declared
