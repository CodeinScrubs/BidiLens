...
tables and 923-case fixtures are generated from the same canonical inputs as
...
semantics. The crate validates the same 923 direction fixtures and all declared
