...
- 923 schema-validated fixtures and native-review metadata, including 196
...
- native Android Kotlin core, Views and Compose adapters, photographed-case
  sample, generated 923-case corpus, JVM/Robolectric tests, lint/AAR/APK gates,
...
- Swift Package core, UIKit adapters, and a UIKit-backed SwiftUI `BidiText`
  ...
  policy, shared 923-case corpus tests, a runnable core example, macOS
  verification, and iOS Simulator adapter tests;
- .NET 8 core and WPF adapters with generated Unicode 17 data, independent
  direction/alignment policy, shared 923-case executable verification, a
...
- native Rust core with generated Unicode 17 data, byte/UTF-16/code-point
  ranges, shared 923-case direction conformance, declared isolation/security
