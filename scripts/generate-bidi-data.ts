...
async function main(): Promise<void> {
  ...
  if (check) {
    const [current, androidCurrent, appleCurrent, windowsCurrent] = await Promise.all([
  ...
  console.log(`Generated web, Android, Apple, and Windows Unicode tables from Unicode ${UNICODE_VERSION}.`);
}
