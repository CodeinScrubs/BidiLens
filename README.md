...
- 925 schema-validated direction fixtures plus property-based random chunking;
...
- Android JVM, Robolectric, lint, APK/AAR, and API 35/36 device gates using the
  same generated 925-case corpus;
...
- a native Rust core with generated Unicode 17 tables, byte/UTF-16/code-point
  ranges, all 925 direction fixtures, declared isolation/security conformance,
